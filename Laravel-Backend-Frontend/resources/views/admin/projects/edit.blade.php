            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body"><div class="row">
                        ...
                        <div class="form-group col-lg-4 col-md-4 col-sm-12">
                            ...
                            <input type="number" class="form-control" name="track" id="track"  placeholder="{{ __('Enter Track e.g. 50') }}" value="{{ old('track',$project->track) }}" min="0"> 
                        </div>
                        ...
                        <div class="form-group col-lg-2 col-md-2 col-sm-6 col-6">
                            ...
                            <input type="number" class="form-control" name="medal" id="medal"  placeholder="{{ __('Enter score') }}" value="{{ old('medal',$ProjectScore->medal) }}" min="1" max="10" step="0.5" required> 
                        </div>

                        <div class="form-group col-lg-2 col-md-2 col-sm-6 col-6">
                            <label><span class="text-danger"></span>{{ __('Heart') }}:</label>
                            <input type="number" class="form-control" name="heart" id="heart"  placeholder="{{ __('Enter score') }}" value="{{ old('heart',$ProjectScore->heart) }}" min="1" max="10" step="0.5" required> 
                        </div>

                        <div class="form-group col-lg-2 col-md-2 col-sm-6 col-6">
                            <label><span class="text-danger"></span>{{ __('Fire') }}:</label>
                            <input type="number" class="form-control" name="fire" id="fire"  placeholder="{{ __('Enter score') }}" value="{{ old('fire',$ProjectScore->fire) }}" min="1" max="10" step="0.5" required> 
                        </div>

                        <div class="form-group col-lg-2 col-md-2 col-sm-6 col-6">
                            <label><span class="text-danger"></span>{{ __('Money Bag') }}:</label>
                            <input type="number" class="form-control" name="money_bag" id="money_bag"  placeholder="{{ __('Enter score') }}" value="{{ old('money_bag',$ProjectScore->money_bag) }}" min="1" max="100" step="1" required> 
                        </div>

                        <div class="form-group col-lg-2 col-md-2 col-sm-6 col-6">
                            <label><span class="text-danger"></span>{{ __('Total') }}:</label>
                            <input type="number" class="form-control" value="{{ old('money_bag',$ProjectScore->total_score) }}" disabled> 
                        </div>
