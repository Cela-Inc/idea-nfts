...
class ProjectController extends Controller
{
  ...
  public function add(Request $request)
  {
    ...
    return view('admin.projects.add',['chains_list' => $chains_list]);
  ...
  { 
      ...
      return view('admin.projects.edit',['project' => $project, 'SupportedBlockchains' => $SupportedBlockchains, 'ProjectScore' => $ProjectScore, 'chains_list' => $chains_list]); 
