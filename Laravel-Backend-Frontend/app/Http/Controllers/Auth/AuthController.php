...
class AuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        try {
            ...
            //     $response = Http::withHeaders(["Authorization" => "Bearer ", "Content-Type" => "application/json"])
            //         ->post('https://paper.xyz/api/v1/oauth/token', ['code' => $request['paper_token'], 'clientId' => '']);
    ...
    public function loginWithPaper(Request $request)
    {
        ...
        try {
            ...
            $response = Http::withHeaders(["Authorization" => "Bearer ", "Content-Type" => "application/json"])
                ->post('https://paper.xyz/api/v1/oauth/token', ['code' => $request['code'], 'clientId' => '']);
    ...
    public function connectPaperWallet(Request $request)
    {
        ...
        try {
            ...
            $userDetails = Http::withHeaders(["Authorization" => "Bearer ", "Content-Type" => "application/json"])
                ->post('https://paper.xyz/api/v1/oauth/user-details', ['userToken' => $response['userToken'], 'clientId' => '']);
